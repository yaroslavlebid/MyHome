...
import yaroslavlebid.apps.myhome.data.apartment.ApartmentPhoto
...
class ApartmentRepositoryImpl(private val db: FirebaseFirestore) : ApartmentRepository {
    ...
    override fun addMockApartmentsToDb() {
        val apartment1 = Apartment(
            ...
            photos = listOf(ApartmentPhoto(mediumImageUrl = "https://cf.bstatic.com/xdata/images/hotel/max1024x768/259260775.jpg?k=120d29e1485e411dcaf89a7e239350a0d2b66ed5872a395cf16c8d22cb100775&o=&hp=1")),
            coverPhotoId = 0,
        ...
        val apartment2 = Apartment(
            ...
            photos = listOf(ApartmentPhoto(mediumImageUrl = "https://sonatahotel.com.ua/wp-content/uploads/2019/07/%D1%84%D0%B0%D1%81%D0%B0%D0%B4-11-815x500.jpg")),
            coverPhotoId = 0,
        ...
        val apartment3 = Apartment(
            ...
            description = "This hotel is located in the heart of Lviv...",
            photos = listOf(ApartmentPhoto(mediumImageUrl = "https://iameco.com.ua/wp-content/uploads/2019/08/136312738.jpg")),
            coverPhotoId = 0,
